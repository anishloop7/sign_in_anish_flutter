...
import 'package:sign_in_anish/ProfileScreen.dart';
             ...
             Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                      Icon(FontAwesomeIcons.google,color: Color(0xfeCE107c),),
                      SizedBox(width:10.0),
                      Text(
                      'Log in with Google',
                ...
                Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: <Widget>[
                      Icon(FontAwesomeIcons.twitter,color: Color(0xff4754de),),
                      SizedBox(width:10.0),
                      Text(
                      'Log in with Twitter',
                      style: TextStyle(color: Colors.black,fontSize: 18.0),
